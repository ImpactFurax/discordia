...
const Navbar = () => {
  ...
  return (
    <nav className='bg-zinc-800 w-full sm:w-fit p-2 fixed z-10 bottom-0 sm:left-0 sm:pt-36 sm:min-h-screen'>
      <div className='flex-between sm:flex-col gap-2 sm:gap-14'>
        {NavLinks.map((link) => {
